      ...
      <Sidebar className="border-r border-gray-200">
         <SidebarHeader className="border-b border-gray-200 p-6">
            <div className="flex items-center space-x-2">
               <div className="w-8 h-8 bg-gradient-to-br from-[#00A9FF] to-[#89CFF3] rounded-lg flex items-center justify-center">
                  ...
                  <SidebarMenu className="space-y-2">
                     {menuItems.map((item) => (
                        <SidebarMenuItem key={item.title}>
                           <SidebarMenuButton asChild className="h-12 px-4 hover:bg-[#A0E9FF]/20 data-[active=true]:bg-[#00A9FF] data-[active=true]:text-white">
