...
export default function SignUpPage() {
   ...
   return (
      <AuthLayout title="Welcome to iELECT" subtitle="Create your account to get started" imageSrc="/images/business-people-thumbs-up.jpg" imageAlt="Business people giving thumbs up" isSignUp>
         <div>
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                        <FormItem>
                           ...
                           <FormControl>
                              <Input placeholder="John Doe" className="border-slate-200" {...field} />
                           </FormControl>
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                        <FormItem>
                           ...
                           <FormDescription className="text-xs text-slate-500">Must be at least 8 characters</FormDescription>
                           <FormMessage className="text-red-500" />
                        </FormItem>
                     )}
                  />
                     ...
                     render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                           ...
                           <div className="space-y-1 leading-none">
                              <FormLabel className="text-sm font-normal text-slate-700">I accept the terms and conditions</FormLabel>
                              <FormMessage className="text-red-500" />
                           </div>
                        </FormItem>
                     )}
