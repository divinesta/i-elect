         ...
         <Tabs defaultValue="basic-info" className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                     {candidates.map((candidate) => (
                        <Card key={candidate.id} className="hover:shadow-lg transition-shadow">
                           <CardContent className="p-4">
                              <div className="text-center space-y-3">
                                 <Image src={candidate.photo || "/placeholder.svg"} alt={candidate.name} className="w-20 h-20 rounded-full mx-auto object-cover" />
                                 <div>
            ...
            <TabsContent value="voters">
               <div className="space-y-6">
                  <Card>
                     <CardHeader>
                        <CardTitle>Voter Accreditation Status</CardTitle>
                        <CardDescription>Manage voter accreditations and approvals</CardDescription>
                     </CardHeader>
                     <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                           <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-center">
                              <div className="text-2xl font-bold text-yellow-800">5</div>
                              <div className="text-sm text-yellow-600">Pending Accreditations</div>
                           </div>
                           <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
                              <div className="text-2xl font-bold text-green-800">{voters.filter((v) => v.status === "Verified").length}</div>
                              <div className="text-sm text-green-600">Approved Voters</div>
                           </div>
                           <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
                              <div className="text-2xl font-bold text-blue-800">{voters.length + 5}</div>
                        ...
                        <div className="flex space-x-4 mb-6">
                           <Button className="bg-[#00A9FF] hover:bg-[#0088CC] text-white" asChild>
                              <Link href={`/elections/${electionId}/admin/dashboard`}>Manage Accreditations</Link>
                           </Button>
                           <Button variant="outline">Export Voter List</Button>
                  ...
                  <Card>
                     <CardHeader>
                        ...
                        <CardDescription>Fields that voters must fill to get accredited</CardDescription>
                     </CardHeader>
                     <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                           <div className="space-y-2">
                  ...
                  <Card>
                     <CardHeader>
                        <CardTitle>Approved Voters ({voters.length})</CardTitle>
